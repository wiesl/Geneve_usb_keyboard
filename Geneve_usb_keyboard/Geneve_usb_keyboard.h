...
//First and Last XT code
#define XT_FIRST_CODE	0x20		//Space
#define XT_LAST_CODE	MK_RALT		//Right Alt
...
//Up key definitons
#define UP_NOUPCD	0x00	//Send no upcode
#define UP_STNDRD	0x10	//Upcode is Dncode | 0x80
#define	UP_AACODE	0x20	//Upcode is this code (0xAA)
#define UP_BITMSK	0x30	

//Option bits
#define OP_NONE		0x00	//Key has no extra option
#define OP_ARPON	0x80	//Key has auto repeat option
#define OP_ESCSCD	0x40	//Key has escaped scancode (0xE0+ScanCode)
...
#define AUTOREPEATDELAY	1000	//Auto repeat delay [ms]
#define AUTOREPEATSPEED 80	//Auto repeat speed [ms]
